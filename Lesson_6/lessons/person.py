...
class Human:
    ...
    f_name: str
    l_name: str
    weight: int  # публичный доступ или открытый
    _password: str  # защищённый доступ, можно обращаться вне класса, но не следует
    __bank_account: str  # приватный доступ или закрытый
...
# получаем доступ к приватной переменной 
print(john._Human__bank_account)  # 123443211234
# безопасный способ доступа к приватной переменной
print(john.show_bank_account())  # Account: 12344*****************
